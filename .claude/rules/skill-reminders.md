...
| Choosing model for sub-agent tasks | **Heuristic**: structured catalog/extraction/classification → Sonnet 5 ($2/$10 per MTok, xhigh-capable) is sufficient and far cheaper. Narrative synthesis / cross-document reasoning / legal-accuracy verification → Opus 5 or Fable 5.1. Don't default-spawn the big model when Sonnet suffices — caught session 278h ($150-300 → $25-50 actual when corrected mid-task). |
